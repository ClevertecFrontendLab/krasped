...
export const ExserciseItem = ({ itemObj, changeItemObj, isOldTraining, isImplementation, index }: { index: number, itemObj: IExercise, changeItemObj: (item: IExercise) => void, isOldTraining: boolean, isImplementation: boolean }) => {
