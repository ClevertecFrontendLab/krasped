...
export const ExserciseItem = ({itemObj, changeItemObj}: {itemObj: IExercise, changeItemObj: (item: IExercise) => void}) => {
    ...
    <div
          ...
          >
            <div><Input value={name} onChange={(e) => chageValueAndSave({name: e.target.value})} size="small" style={{ height: "24px" }}
              addonAfter={<Checkbox checked={isSelectedForDelete} onChange={(e) => chageValueAndSave({isSelectedForDelete: !!e})} style={{ marginTop: "-5px" }}></Checkbox>}
